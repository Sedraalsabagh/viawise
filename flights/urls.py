...
urlpatterns = [
    ...
    path('flight_details/<int:flight_id1>/<int:flight_id2>', views.flight_details, name='flight_details'),
    path('flight_details/<int:flight_id1>', views.flight_details1, name='flight_details'),
