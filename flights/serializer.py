...
class FlightProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Flight
        fields = ['id','notes','ratings','departure_date', 'airportDeparture', 'airportArrival', 'departure_city', 'destination_city', 'departure_country', 'destination_country', 'price_flight', 'airline_name','Airplane']
